...
import AboutCardBusiness from "@/components/global/AboutCardBusiness";
...
import LicensesCertificateBusiness from "@/components/pages/LicensesCertificateBusiness";
      ...
      {!isLoading && (
        <div className="flex flex-col lg:grid lg:grid-cols-9 gap-8">
          <div className="col-span-6 space-y-5">
            ...
            <WhiteWrapper>
              <LicensesCertificateBusiness
			   dataForLicense={data && data.data}
                licenseAndCertificateSchema={
                  data && data.data.licenseAndCertificateSchema
                }
              />
            </WhiteWrapper>
          </div>
