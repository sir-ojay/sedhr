...
const SingleTraining = ({ trainingInfo, categories }: SingleTrainingProps) => {
	return (
		<DefaultLayout title='Sedher | Adagio CME-CPD Training Services'>
			<GoBackButton label='My Training' />
								...
								<div className='space-y-2'>
									<div className='font-epilogue text-dark-100 leading-[160%] flex'>
										...
										<div className='w-[calc(100%-20px)]'>
											...
											3, Oyewole Close, Off Adebowale St, Ojodu, 100213, Ikeja{" "}
											<Button tag='a' href='/my-items/my-training'>
												(Map location)
											</Button>
										</div>
									</div>
									<div className='font-epilogue text-dark-100 leading-[160%] flex'>
										...
										<div className='w-[calc(100%-20px)]'>
											...
											Mask required · Staff wear masks · Staff required to
