import { useAddLicenseMutation } from "@/services/profile";
...
const LicensesCertificate = ({ educations }: any) => {
	const month = [
		"January",
		"February",
		"March",
	...
	const [addLicense, { isLoading: loading }] = useAddLicenseMutation();
...
export default LicensesCertificate;
