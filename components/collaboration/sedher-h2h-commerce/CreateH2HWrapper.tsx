...
const CreateH2HWrapper = ({ children, steps, step }: CreateH2HWrapperProps) => {
	return (
		<section>
...
export default CreateH2HWrapper;

CreateH2HWrapper.defaultProps = {
	steps: [
		{
